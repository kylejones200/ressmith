...
def solution_gas_drive_material_balance(
    ...
    # Left side: Np * Bo (calculated but not used in this implementation)
...
def water_drive_material_balance(
    ...
    water_influx_params: dict | None = None,
) -> dict[str, float]:
...
def gas_reservoir_pz_method(
    ...
    """
    from ressmith.primitives.pvt import gas_z_factor
...
def identify_drive_mechanism(
    ...
    water_cut_history: np.ndarray | None = None,
    gor_history: np.ndarray | None = None,
) -> str:
